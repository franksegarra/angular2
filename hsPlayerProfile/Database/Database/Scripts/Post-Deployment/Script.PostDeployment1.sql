...
INSERT INTO activityTypes (activitytype) VALUES ('High School Game')
INSERT INTO activityTypes (activitytype) VALUES ('Tournament')
INSERT INTO activityTypes (activitytype) VALUES ('Showcase')
GO
...
INSERT INTO highSchools (highSchoolName) VALUES ('Carmel High School')
GO

INSERT INTO students (lastName, firstName, highSchoolId, profileName)
VALUES ('Segarra', 'Francis', 1, 'FrancisSegarra')
GO

INSERT INTO activities (activity) VALUES ('Baseball')
INSERT INTO activities (activity) VALUES ('Basketball')
INSERT INTO activities (activity) VALUES ('Football')
INSERT INTO activities (activity) VALUES ('Soccer')
INSERT INTO activities (activity) VALUES ('Violin')
INSERT INTO activities (activity) VALUES ('Graphic Arts')
GO

INSERT INTO activityTypes (activity) VALUES ('High School Game')
INSERT INTO activityTypes (activity) VALUES ('Tournament')
INSERT INTO activityTypes (activity) VALUES ('Showcase')
GO
...
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'03/25/2017','11:00 AM',1,'@Briarcliff High School',1,'Briarcliff High School, 444 Pleasantville Rd, Briarcliff Manor, NY 10510, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'03/31/2017','04:30 PM',1,'@Ramapo High School',1,'Ramapo High School, 400 Viola Rd, Spring Valley, NY 10977, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/03/2017','04:00 PM',1,'@Lakeland High School',1,'Lakeland High School, 1349 E Main St, Shrub Oak, NY 10588, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/04/2017','04:30 PM',1,'New Rochelle',1,'Carmel High School, County Center, Carmel, NY 10512, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/06/2017','04:30 PM',1,'@Portchester High School',1,'Port Chester High School, 1 Tamarack Rd, Port Chester, NY 10573, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/08/2017','11:30 AM',1,'@Horace Greely',1,'Horace Greeley High School, 70 Roaring Brook Rd, Chappaqua, NY 10514, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/10/2017','11:00 AM',1,'Mahopac',1,'Carmel High School, County Center, Carmel, NY 10512, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/12/2017','11:00 AM',1,'@Mahopac High School',1,'Mahopac High School, 421 Baldwin Place Rd, Mahopac, NY 10541, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/15/2017','11:00 AM',1,'Pawling High School',1,'Carmel High School, County Center, Carmel, NY 10512, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/18/2017','04:30 PM',1,'Ketcham',1,'Carmel High School, County Center, Carmel, NY 10512, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/20/2017','04:30 PM',1,'@Ketcham',1,'Roy C Ketcham Senior High School, 99 Myers Corners Rd, Wappingers Falls, NY 12590, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/22/2017','02:00 PM',1,'Croton Harmon',1,'Carmel High School, County Center, Carmel, NY 10512, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/24/2017','04:00 PM',1,'Yorktown',1,'Carmel High School, County Center, Carmel, NY 10512, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/26/2017','04:30 PM',1,'@John Jay East Fishkill',1,'John Jay Senior High School, 2012 NY-52, Hopewell Junction, NY 12533, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'04/28/2017','04:30 PM',1,'John Jay East Fishkill',1,'Carmel High School, County Center, Carmel, NY 10512, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'05/02/2017','04:30 PM',1,'Arlington High School',1,'Carmel High School, County Center, Carmel, NY 10512, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'05/04/2017','04:30 PM',1,'@Arlington High School',1,'Arlington High School, 1157 State Rte 55, Lagrangeville, NY 12540, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'05/06/2017','01:30 PM',1,'@Fox Lane',1,'Fox Lane High School, Mt Kisco, NY 10549, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'05/08/2017','04:30 PM',1,'@Brewster',1,'Brewster High School, 50 Foggintown Rd, Brewster, NY 10509, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'05/09/2017','04:00 PM',1,'@Somers',1,'Somers High School, 120 Primrose St, Lincolndale, NY 10540, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'05/11/2017','04:00 PM',1,'Walter Panas',1,'Carmel High School, County Center, Carmel, NY 10512, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'06/19/2017','12:00 AM',1,'Diamond Nation',2,'Diamond Nation, 5 Bartles Corner Rd, Flemington, NJ 08822, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'06/26/2017','12:00 AM',1,'Diamond Nation',2,'Diamond Nation, 5 Bartles Corner Rd, Flemington, NJ 08822, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'07/10/2017','12:00 AM',1,'Boston Invitational - NorthBorough MA',2,'New England Baseball Complex, 333 SW Cutoff, Northborough, MA 01532, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'07/13/2017','12:00 AM',1,'Boston Open Northborough, MA',2,'New England Baseball Complex, 333 SW Cutoff, Northborough, MA 01532, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'07/21/2017','12:00 AM',1,'Fordham Showcase Camp',2,'Fordham University, Bronx, NY 10458, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'07/31/2017','12:00 AM',1,'Blue Chip Wood Bat',2,'Diamond Nation, 5 Bartles Corner Rd, Flemington, NJ 08822, USA') 
Insert into studentSchedules (studentid,Date,Time,activityid,Event,Type,Location) values (1,'08/15/2017','12:00 AM',1,'Evolution Showcase',3,'TBD') 
GO
